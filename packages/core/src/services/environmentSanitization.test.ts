...
describe('sanitizeEnvironment', () => {
  ...
  it('should redact variables with values matching all token and credential patterns', () => {
    const env = {
      ...
      // Stripe(纯假占位值;拼接仅为规避 GitHub push protection 误报)
      STRIPE_SK_LIVE: 'sk_li' + 've_xxxxxxxxxxxxxxxxxxxxxxxx',
      STRIPE_RK_LIVE: 'rk_l' + 'ive_xxxxxxxxxxxxxxxxxxxxxxxx',
      STRIPE_SK_TEST: 'sk_te' + 'st_xxxxxxxxxxxxxxxxxxxxxxxx',
      STRIPE_RK_TEST: 'rk_te' + 'st_xxxxxxxxxxxxxxxxxxxxxxxx',
      // Slack
